...
const Header = ({ toggleSidebar, isSidebarOpen }) => {
    ...
    return (
        <header className="bg-white  border-b border-gray-200 dark:border-gray-700 shadow-sm py-3 px-4 md:px-6 flex justify-between items-center sticky top-0 z-30">
